...
// e0
  ...
  KBD_FAKE_LSHIFT, KBD_FAKE_RSHIFT,
...
enum
{
  KBD_META_LSHIFT = 0x00, KBD_META_RSHIFT = 0x01, KBD_META_SHIFT = 0x10,
  KBD_META_LCTRL  = 0x02, KBD_META_RCTRL  = 0x03, KBD_META_CTRL  = 0x11,
  KBD_META_LALT   = 0x04, KBD_META_RALT   = 0x05, KBD_META_ALT   = 0x12,
  KBD_META_LLOGO  = 0x06, KBD_META_RLOGO  = 0x07, KBD_META_LOGO  = 0x13,
